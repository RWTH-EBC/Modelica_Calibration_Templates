within CalibrationTemplates.SimulatorTemplates;
partial model CalibrationSimulator
  extends CalibrationTemplates.SimulatorTemplates.BaseClasses.PartialCalibrationSimulator;
  ...
  replaceable InterfaceRouters.PreProcessor preProcessor constrainedby InterfaceRouters.PreProcessor "Replace with your own preprocessing" annotation (
    Dialog(group="Processing"),
    Placement(transformation(extent={{-84,-76},{-56,84}})),
    choicesAllMatching=true);
  replaceable InterfaceRouters.PostProcessor postProcessor constrainedby InterfaceRouters.PostProcessor "Replace with your own postprocessing" annotation (
    Dialog(group="Processing"),
    Placement(transformation(extent={{52,-76},{84,84}})),
    choicesAllMatching=true);
